if (isMobile()) {
    var heightArray = ["920", "940", "940", "1820", "1820"];
    var recommendHeight = ["1660", "1660", "1747", "1747", "1880"];
} else {
    var heightArray = ["1050", "1060", "1040", "1920", "1040"];
    var recommendHeight = ["1040", "1040", "1040", "1040", "1040"];
}
var pageIndex = 0;
...
var step_4 = function () {
    function enter() {
        if (!isMobile()) {
            $("section").css({
                "height": ($(window).height() + 20) / scaleVal + "px"
            });
        } else {
            $("section").css({
                "height": "auto"
